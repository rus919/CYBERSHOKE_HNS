...
{	
	if(IsPlayerAlive(client))
	{
		...
		if(g_iHud[client][1]==0)
			Format(sResult, sizeof(sResult),"<b>Last Jump</b>: <font color='#948d8d'>%.1f</font> (%s)\n<b>Speed</b>: %.1f u/s (%.0f)\n%s",g_fJSSave[client][LAST_JUMP],szDirEnum[GetDirection(client)],GetSpeed(client),g_fJS[client][PRE_JUMP],sResult);
		else if(g_iHud[client][1]==1)
			Format(sResult, sizeof(sResult),"<b>Last Jump</b>: <font color='#2384CD'>%.1f</font> (%s)\n<b>Speed</b>: %.1f u/s (%.0f)\n%s",g_fJSSave[client][LAST_JUMP],szDirEnum[GetDirection(client)],GetSpeed(client),g_fJS[client][PRE_JUMP],sResult);
		else if(g_iHud[client][1]==2)
			Format(sResult, sizeof(sResult),"<b>Last Jump</b>: <font color='#40831C'>%.1f</font> (%s)\n<b>Speed</b>: %.1f u/s (%.0f)\n%s",g_fJSSave[client][LAST_JUMP],szDirEnum[GetDirection(client)],GetSpeed(client),g_fJS[client][PRE_JUMP],sResult);
		else if(g_iHud[client][1]==3)
			Format(sResult, sizeof(sResult),"<b>Last Jump</b>: <font color='#D80000'>%.1f</font> (%s)\n<b>Speed</b>: %.1f u/s (%.0f)\n%s",g_fJSSave[client][LAST_JUMP],szDirEnum[GetDirection(client)],GetSpeed(client),g_fJS[client][PRE_JUMP],sResult);																												
		else if(g_iHud[client][1]==4)
			Format(sResult, sizeof(sResult),"<b>Last Jump</b>: <font color='#F2D500'>%.1f</font> (%s)\n<b>Speed</b>: %.1f u/s (%.0f)\n%s",g_fJSSave[client][LAST_JUMP],szDirEnum[GetDirection(client)],GetSpeed(client),g_fJS[client][PRE_JUMP],sResult);				
