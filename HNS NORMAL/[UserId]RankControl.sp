...
public void OnPluginStart()
{
	...
	RegConsoleCmd("sm_resetrank", Jump_Cmd1, "js");
...
public Action Jump_Cmd1(int client, int args){
...
public void ResetPoints(int client)
{
...
static void SendHud(int client)
{
	...
	if(GetClientTeam(client)==2)//t
	{
		...
		SetHudTextParams(0.01, 0.01, 0.2, 100, 100, 255, 255);
