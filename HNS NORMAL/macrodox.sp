...
#define DELETE_CMD "sm_delstats"

//Command used to delayed ban.
//Default is "banid 0 %s kick"
//#define BAN_CMD "sm_ban %s 0 Bhop"
...
BanDelayed(client, const String:type[])
{
    ...
    //ServerCommand("sm_ban #%i 43800 \"BhopDetected | %s:%i\"", GetClientUserId(client), ip, port);
    CS_Admin_SetBan(0, client, 259200, "BhopDetected");
}
DoBans()
{
    new Handle:banfile = OpenFile(pathdat, "a+");
