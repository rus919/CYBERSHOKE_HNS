    ...
    { 
        ...
        { 
            if(g_hMarked_dmg[victim]==INVALID_HANDLE && g_hMarked_dmg[attacker]!=INVALID_HANDLE)
            {
                ...
                PrintToChat(attacker,"\x01\04 \x04CYBERSHOKE \x01| \x09Вы получили урон и не можете бить!");
        ...
        { 
            ImmunePlayer(victim);
            PrintToChat(attacker,"\x01\04 \x04CYBERSHOKE \x01| \x09Нельзя бить так часто!");
            return Plugin_Handled; 
        } 
    } 
